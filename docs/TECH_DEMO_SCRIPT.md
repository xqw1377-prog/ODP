...
| --- | --- | --- |
| 0:00–0:15 | repo + `npm run build && npm test` output | "A TypeScript monorepo with frozen domain, Passport, Matching and Distribution contracts, full suite green in CI, plus a Rust cross-check on the Merkle wire format." |
