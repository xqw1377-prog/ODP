...
| 0:15–0:40 | `/radar` (live devnet data) | "Discover: three projects on the radar. Verdicts are DERIVED from evidence — derivation-locked: a passport that disagrees with its evidence cannot even parse." |
...
| 1:05–1:35 | `/distribution/aurora` | "Match: only ALLOW projects enter. Interest fit 55%, human confidence 20%, reputation 15%, network 10%. Sib is BLOCKED — risk flags hard-block at zero. And watch: match score is NOT token entitlement — 0.942 and 0.491 both get 1,000." |
